...
include_once("inc/checksession.inc.php");include_once("com/Product.php");
...
?> <div class="quick" style=""><a href="add-edit-service.php?action=add"  style="float:right; padding-right:10px;"><h3>Add New</h3></a></div>
...
?>
	    ...
	    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="add-edit-service.php?action=edit&&id=<?php echo siteEncrypt($select[$i]["id"]);?>" style="background-image: none;float: left;"><img src="images/edit_icon.png" alt="Edit" title="Edit" /></a>
                  <?php if($_SESSION['admin-type']!='Editor'){?> <a href="service-mgmt.php?action=delete&&id=<?php echo siteEncrypt($select[$i]["id"]);?>" style="background-image: none;float: left;"><img src="images/delete_icon.png" alt="Edit" title="Edit" /></a> <?php } ?>  </td>
