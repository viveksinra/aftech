...
$("#subcategory").html(html);
  ...
  <div class="form-group">
                                            <label>Select SubCategory</label>
											      <select class="form-control " id="subcategory" name="subcategory"  ng-model="model.select">
              <option value="">Select Sub category </option>

              </select>
                      <input class="form-control" type="hidden" name="subcategory1" value="<?php echo $sel_adm[0]['subcategory']?>"  required=""/>
