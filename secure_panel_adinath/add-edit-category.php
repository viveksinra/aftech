                        ...
                        <div class="panel-body">
                            <div class="row">
                                 ...
                                 <div class="form-group">
                                            <label>Photo</label>
                               <input class="form-control" type="file" name="photo" value="<?php echo $sel_adm[0]['photo']?>"  required=""/>
                               <input class="form-control" type="hidden" name="photo1" value="<?php echo $sel_adm[0]['photo']?>"  required=""/>
                                        </div>
                                      <div class="form-group">
                                            <label>Category</label>
                               <input class="form-control" type="text" name="category" value="<?php echo $sel_adm[0]['category']?>"  required=""/>
                                        </div>
                                  
                                    <div class="form-group">
                                            <label>Button Name</label>
                               <input class="form-control" type="text" name="btn_name" value="<?php echo $sel_adm[0]['btn_name']?>"  required=""/>
                                        </div>   
						  <div class="form-group">
                                            <label>Detail</label>
