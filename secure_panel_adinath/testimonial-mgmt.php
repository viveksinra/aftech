...
include_once("inc/checksession.inc.php");include_once("com/Testimonial.php");
...
?> <div class="quick" style=""><a href="add-edit-testimonial.php?action=add"  style="float:right; padding-right:10px;"><h3>Add New</h3></a></div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
            $select = $db->fetchAssoc($db->fireQuery("select * from `testimonial`"));
	    ...
	    ?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $i+1;?></td>
											 ...
											 <td class="center"><?php echo $select[$i]['msg']?></td>
                                            <td class="center"><a href="add-edit-testimonial.php?action=edit&&id=<?php echo siteEncrypt($select[$i]["id"]);?>" style="background-image: none;float: left;"><img src="images/edit_icon.png" alt="Edit" title="Edit" /></a>
                  <?php if($_SESSION['admin-type']!='Editor'){?> <a href="testimonial-mgmt.php?action=delete&&id=<?php echo siteEncrypt($select[$i]["id"]);?>"  style="background-image: none;float: left;"><img src="images/delete_icon.png" alt="Edit" title="Edit" /></a> <?php } ?>  </td>
