...
function deleteRow() {
            ...
            if ($(this).is(':checked')) {
				$(item).remove();
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                            <label>Company</label>
                               <input class="form-control" type="text" name="company" value="<?php echo $sel_adm[0]['company']?>"  required=""/>
                                        </div>             
                                      <div class="form-group">
                                            <label>Name</label>
  ...
  <div class="form-group">
                                            <label>Color</label>
                               <input class="form-control" type="color" name="color" value="<?php echo $sel_adm[0]['color']?>"  required=""/>
                                        </div>											
  <DIV id="product">
<?php require_once("input.php") ?>
</DIV><br/>
<DIV class="btn-action float-clear" style="display:block"><br/><br/>
