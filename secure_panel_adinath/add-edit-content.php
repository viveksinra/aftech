                                    ...
                                    <form  form name="frm1" method="post" enctype="multipart/form-data">
                                      <div class="form-group">
                                            ...
                                            <select class="form-control" name="category" id="category">
                                               ...
                                               <option value="Home" <?php if($sel_adm[0]['category']=="Home"){echo "selected";}?>>Home</option>
											   <option value="About Us" <?php if($sel_adm[0]['About Us']=="About Us"){echo "selected";}?>>About Us</option>
											   <option value="Contact Us" <?php if($sel_adm[0]['category']=="Contact Us"){echo "selected";}?>>Contact Us</option>
												 <option value="Terms" <?php if($sel_adm[0]['category']=="Terms"){echo "selected";}?>>Terms & Condition</option>
												 <option value="privacy Policy" <?php if($sel_adm[0]['category']=="privacy Policy"){echo "selected";}?>>privacy Policy</option>
												 <option value="Refund Policy" <?php if($sel_adm[0]['category']=="Refund Policy"){echo "selected";}?>>Refund Policy</option>
										 <option value="Mission" <?php if($sel_adm[0]['category']=="Mission"){echo "selected";}?>>Mission</option>
										  <option value="Vision" <?php if($sel_adm[0]['category']=="Vision"){echo "selected";}?>>Vision</option>
										  <option value="Why" <?php if($sel_adm[0]['category']=="Why"){echo "selected";}?>>Why Choose</option>
										   </select>
                                        </div>
