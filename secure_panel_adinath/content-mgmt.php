...
include_once("inc/checksession.inc.php");include_once("com/Content.php");
...
?> <div class="quick" style=""><a href="add-edit-content.php?action=add"  style="float:right; padding-right:10px;"><h3>Add New</h3></a></div>
...
?>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
            $select = $db->fetchAssoc($db->fireQuery("select * from `content`"));
	    ...
	    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo $select[$i]['category']?></td>
											 <td class="center"><?php echo $select[$i]['heading']?></td>
											 <td class="center"><?php echo $select[$i]['detail']?></td>
                                            <td class="center"><a href="add-edit-content.php?action=edit&&id=<?php echo siteEncrypt($select[$i]["id"]);?>" style="background-image: none;float: left;"><img src="images/edit_icon.png" alt="Edit" title="Edit" /></a>
